...
describe 'user can print out statements' do
  it 'can print a single transaction' do
    ...
    expect { PrintOut.statement_of(account.transactions) }.to output("date || credit || debit || balance\n10-01-2012 || 1000.00 ||   || 1000.00\n").to_stdout
    expect(PrintOut.statement_of(account.transactions)).to eq("bank statement printed")
  end
